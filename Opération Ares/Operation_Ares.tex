...
% Le courrier est tapé à la machine, pas d'empreintes, posté depuis pusieurs
% villages différents aux alentours de Toulouse.
% Après avoir été interrogée, elle va poster à raison de une fois par semaine
% les papiers d'identités de ses victimes pour faire monter la pression sur
% le narrateur.
% La tueuse est une artisan relieuse qui possède une boutique en ville.
% Elle trouvera le nom de la future ex-femme sur la convocation à l'audience
% qui trainera sur un bureau chez le narrateur, près d'une photo.
% Elle dissoud les bas des corps dans l'acide, chez elle, dans la campagne.
